...
import com.kan_n.databinding.FragmentNhaplaiMatkhauBinding;
import com.kan_n.ui.activities.MainActivity;

public class NhapLaiMatKhauFragment extends Fragment {
    private FragmentNhaplaiMatkhauBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentNhaplaiMatkhauBinding.inflate(inflater, container, false);
