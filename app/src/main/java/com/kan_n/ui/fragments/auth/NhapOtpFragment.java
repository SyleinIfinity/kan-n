...
import com.kan_n.databinding.FragmentNhapOtpBinding;
import com.kan_n.ui.activities.MainActivity;

public class NhapOtpFragment extends Fragment {
    private FragmentNhapOtpBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentNhapOtpBinding.inflate(inflater, container, false);
